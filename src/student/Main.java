...
public class Main {
    ...
    public static void failList() {
        ...
        String courseName;
        switch (course) {
            case 1: courseName = "高等数学";break;
            case 2: courseName = "大学英语";break;
            case 3: courseName = "计算机导论";break;
            case 4: courseName = "体育";break;
            default: System.out.println("课程编号输入错误！");return;
        }
        System.out.println("\n" + courseName + "不及格学生名单：");
        System.out.println("--------------------------------------------");
        for (Student s : list) {
            float score;
            switch (course) {
                case 1: score = s.getMath();break;
                case 2: score = s.getEnglish();break;
                case 3: score = s.getCs();break;
                case 4: score = s.getPe();break;
                default: return;
            }
            if (score < 60) {
                System.out.println(
